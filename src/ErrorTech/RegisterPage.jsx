    ...
    <div style={{display:"flex",flexDirection:"column",justifyContent:"space-between",width:"100vw",height:"100vh"}}>
        <div className='Navbar'>
            ...
            <div className='PagesCpntainer'>
                ...
                <Link className='link' to="/RegisterPage"><div style={toggleOn ? { color: 'lightblue'  } : {color:"#7d2804"}}>Register</div></Link>
        ...
        <div className='Product4' style={toggleOn ? { backgroundColor:"#172838",backgroundImage:"radial-gradient(#2f2c4f 8%,transparent 0)",boxShadow:" inset 0 0 5rem 2rem #000" } : null}>
            ...
            <div className='ButtonContainer'>
                <button style={toggleOn ? { backgroundColor: '#677480',color:"lightblue"} : null} disabled>Login</button>
            </div>
